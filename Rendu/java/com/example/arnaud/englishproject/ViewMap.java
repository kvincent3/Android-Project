...
public class ViewMap {
	...
	public ViewMap(Activity a, Boolean toTouch) {
        ...
        this.displayedIcon = (ImageView) activity.findViewById(R.id.imageView1);
	...
	public void LoadHistoryMap(final ArrayList<DataHistory> datahistory)
	{
		...
		if (this.map !=null && datahistory!=null)
		{
			...
			for (int j=0; j < datahistory.size();j++) {
				...
				final ArrayList<String> story = datahistory.get(j).getStory();
                ...
                map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                    ...
                    public boolean onMarkerClick(Marker marker) {
                        ...
                        ArrayList<String> story = getStoryFromMarker(datahistory, marker.getTitle());
		...
		if (map != null) {
			...
			if (l != null) {
				...
				if (l.getZoom() != -1) {
                    ...
                    try
                    {
                        InputStream bitmap = activity.getAssets().open("touch_screen.jpg");
                        Bitmap bit = getResizedBitmap(BitmapFactory.decodeStream(bitmap), 200, 200);
                        getDisplayedIcon().setImageBitmap(bit);
                        Log.d("Icon", "refresh icon between questions");
                    }
    ...
    public boolean checkAccurancy(String answer){
        ...
        return touched.equals(l);

    }

	public boolean checkAccurancyDeprecated(String answer) {
    ...
    public ArrayList<String> getStoryFromMarker(ArrayList<DataHistory> d, String markerTitle){
    ...
    public ImageView getDisplayedIcon(){
